...
$$log(\lambda_i) =  log({aire_{i}}) + \mu_0 + \gamma_j + \alpha_0 * cov_{2004}+\alpha_1 * cov_{2005} +\alpha_2 * cov_{2006}+ \beta * prev_i,\:\:avec\:\:i=1,...,30\:\:et\:\:j=1,...,10$$
...
- $\gamma_j\:{\sim}\:\mathcal{N}(0,\tau),\:avec\:\:\gamma_j\:\:le\:\:coefficient\:\:spécifique\:\:sur\:\:l'intercept\:\: associé\:\:\:à\:\:\:l'effet\:\:du\:\:j^{ème}\:\:site,avec\:\:\tau\:=\:\sigma_{s}^2$
