...
\% latex table generated in R 4.3.2 by xtable 1.8-4 package \% Thu Dec
21 12:11:43 2023

\begin{tabular}{llr}
  \hline
Model\_name & Formulas & DIC \\ 
 M1 & \$log($\backslash$lambda) = log(aire\_i) + $\backslash$mu\_0 + $\backslash$beta * prev\_i\$ & 94.62 \\ 
  \end{tabular}
